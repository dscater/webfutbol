...
const breadbrums = [
    ...
    {
        title: "Reporte Lista de Jugadores por Equipos",
        disabled: false,
        url: "",
        name_url: "",
    },
...
const generarReporte = () => {
    ...
    const url = route("reportes.r_equipo_jugadors", form.value);
...
<template>
    <Head title="Reporte Lista de Jugadores por Equipo"></Head>
    <v-container>
